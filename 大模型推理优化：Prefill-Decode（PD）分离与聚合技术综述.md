...
PD分离与PD聚合是大模型推理优化的两大核心策略。PD分离通过解耦Prefill和Decode阶段，针对各自特性独立优化资源分配，显著提升吞吐量和降低延迟，适合大规模、高性能场景；PD聚合通过合并计算逻辑和智能调度，降低资源需求和部署复杂度，适用于资源受限场景。开源项目如Mooncake、DistServe和SGLang为PD优化的研究与应用提供了重要支持，未来随着硬件发展和生态建设，PD优化技术将在大模型推理中发挥更大作用。参考文献：
